  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        <div className="mb-8">
          <h1 className="text-[30px] md:text-[40px]">Impressum</h1>
        </div>
        ...
        <div className="space-y-10">
          ...
          <section>
            <h2 className="text-xl mb-4 flex items-center">
              <Mail className="w-6 h-6 text-ergo-red mr-3 shrink-0" />
            ...
            <div className="ergo-card p-6">
              <div className="space-y-2 text-ergo-ink">
                ...
                <div className="mt-4 flex items-start">
                  <MapPin className="w-5 h-5 text-ergo-red mr-2 mt-0.5 shrink-0" />
                  <div>
          ...
          <section>
            <h2 className="text-xl mb-4 flex items-center">
              <Phone className="w-6 h-6 text-ergo-red mr-3 shrink-0" />
              Kontakt
            </h2>
            <div className="ergo-card p-6">
              <div className="space-y-3 text-ergo-ink">
                <div className="flex items-center">
                  <Phone className="w-4 h-4 text-ergo-red mr-3 shrink-0" />
                  <div>
                ...
                <div className="flex items-center">
                  <Mail className="w-4 h-4 text-ergo-red mr-3 shrink-0" />
                  <div>
          ...
          <section>
            <h2 className="text-xl mb-4">Berufsbezeichnung und berufsrechtliche Regelungen</h2>
            <div className="ergo-card p-6">
              <div className="space-y-3 text-ergo-ink">
                <div>
          ...
          <section>
            <h2 className="text-xl mb-4">Berufshaftpflichtversicherung</h2>
            <div className="ergo-card p-6">
              <div className="space-y-2 text-ergo-ink">
          ...
          <section>
            <h2 className="text-base sm:text-xl mb-4">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
            <div className="ergo-card p-6">
              <div className="space-y-3 text-ergo-ink">
                <p>
          ...
          <section>
            <h2 className="text-xl mb-4">Haftung für Inhalte</h2>
          ...
          <section>
            <h2 className="text-xl mb-4">Haftung für Links</h2>
            <p className="text-ergo-stone leading-relaxed">
          ...
          <section>
            <h2 className="text-xl mb-4">Urheberrecht</h2>
            <p className="text-ergo-stone leading-relaxed">
